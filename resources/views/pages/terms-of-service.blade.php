...
<br><br>
    <div class="terms-text">
        ...
        <div class="section">
            ...
            <h2 class="text-left">These Terms govern:</h2>
            ...
            <p class="!font-medium">This Application is provided by:</p>
        ...
        <div class="section">
            ...
            <p class="!font-medium">By using this Application, Users confirm to meet the following requirements:</p>
            ...
            <p class="!font-medium">Users can terminate their account and stop using the Service at any time by doing the following:</p>
            ...
            <p class="!font-medium">However, the Owner reserves the right to remove, delete, block or rectify such content at its own discretion and to, without prior notice, deny the uploading User access to this Application:</p>
            ...
            <p class="!font-medium">Therefore, the Owner reserves the right to take any appropriate measure to protect its legitimate interests including by denying Users access to this Application or the Service, terminating contracts, reporting any misconduct performed through this Application or the Service to the competent authorities - such as judicial or administrative authorities - whenever Users engage or are suspected to engage in any of the following activities:</p>
        ...
        <div class="section">
            ...
            <h3 class="first">EU Users</h3>

            <p class="!font-medium text-center">Indemnification</p>
        ...
        <div class="section">
            ...
            <p class="!font-medium">To the maximum extent permitted by applicable law, in no event shall the Owner, and its subsidiaries, affiliates, officers, directors, agents, co-branders, partners, suppliers and employees be liable for</p>
            ...
            <p class="!font-medium">The User agrees to defend, indemnify and hold the Owner and its subsidiaries, affiliates, officers, directors, agents, co-branders, partners, suppliers and employees harmless from and against any and all claims or demands, damages, obligations, losses, liabilities, costs or debt, and expenses, including, but not limited to, legal fees and expenses, arising from</p>
        ...
        <div class="section">
            ...
            <p>Each party specifically waives any right to trial by jury in any court in connection with any action or litigation.
            Any claims under these terms shall proceed individually and no party shall join in a class action or other proceeding with or on behalf of others.</p>


            <h3>US Users</h3>

            <p class="!font-medium">Surviving provisions</p>
