...
<br><br>
    <div class="terms-text">
        <div class="section">
            ...
            <h3 class="first">General information</h3>
...
<div class="section">
        <h2>2. Hosting</h2>
        <p class="text-center !font-medium mt-4 mb-8">We are hosting the content of our website at the following provider:</p>

        <h3 class="first">External Hosting</h3>
        ...
        <p class="!font-medium">We are using the following host(s):</p>
    <p>
        <span class="font-medium">SiteGround Spain S.L.</span><br>
        Calle de Prim 19<br>
        28004 Madrid<br>
        Spain</p>
...
<h3 class="first">Data protection</h3>
        ...
        <p class="!font-medium">The data processing controller on this website is:</p>
        <p>
        <span class="font-medium">True Crime Metrix, Ltd.</span><br>
        12 Castlehaven Road<br>
        Londoon, NW1 8QW<br>
        United Kingdon<br><br>

        Phone: <a href="tel:+44 207 485 8594">+44 207 485 8594</a><br>
        E-mail: <a href="hello@triuecrimemetrix.com">hello@triuecrimemetrix.com</a></p>
...
<h3>Rejection of unsolicited e-mails</h3>
        ...
        <div class="section">
            ...
            <h3 class="first">eRecht24 Safe Sharing Tool</h3>
        ...
        <div class="section">
            ...
            <h3 class="first">Google Tag Manager</h3>
            ...
            <p>Data transmission to the US is based on the Standard Contractual Clauses (SCC) of the European Commission. Details can be found here: <a href="https://privacy.google.com/businesses/controllerterms/mccs/" target="_blank" aria-label="Go to Google privacy information">https://privacy.google.com/businesses/controllerterms/mccs/</a>.</p>
            ...
            <p><a href="https://tools.google.com/dlpage/gaoptout?hl=en" target="_blank" aria-label="Go to Google Tools site">https://tools.google.com/dlpage/gaoptout?hl=en</a>.</p>

            <p>For more information about the handling of user data by Google Analytics, please consult Google's Data Privacy Declaration at:</p>
            <p><a href="https://support.google.com/analytics/answer/6004245?hl=en" target="_blank" aria-label="Go to Google Analytics site">https://support.google.com/analytics/answer/6004245?hl=en</a>.</p>
            ...
            <p>For further information on how to object to the advertisements displayed by Google, please see the following links:<br>
            <a href="https://policies.google.com/technologies/ads" target="_blank" aria-label="Go to Google Ad policies site">https://policies.google.com/technologies/ads</a> and <a href="https://adssettings.google.com/authenticated" target="_blank" aria-label="Go to Google Ads settings site">https://adssettings.google.com/authenticated</a>.</p>
        ...
        <div class="section">
            ...
            <h3 class="first">YouTube with expanded data protection integration</h3>
        ...
        <div class="section font-light flex justify-between text-sm">
           <span>Updated: December 24, 2025.</span>
           <span>True Crime Metrix Ltd. | &copy; {{date('Y', time())}}</span>
        </div>
